...
- [Домашнє завдання: Рекурсія та алгоритми](#домашнє-завдання-рекурсія-та-алгоритми)
  - [Завдання 1: Рекурсивне копіювання та сортування файлів](#завдання-1-рекурсивне-копіювання-та-сортування-файлів)
    - [Опис](#опис)
    - [Використання](#використання)
    - [Принцип роботи](#принцип-роботи)
    - [Обробка помилок](#обробка-помилок)
  - [Завдання 2: Сніжинка Коха](#завдання-2-сніжинка-коха)
    - [Опис](#опис-1)
    - [Використання](#використання-1)
    - [Алгоритм](#алгоритм)
    - [Особливості](#особливості)
  - [Завдання 3: Ханойські вежі](#завдання-3-ханойські-вежі)
    - [Опис](#опис-2)
      - [Правила](#правила)
